                ...
                <div className={s.container}>
                    ...
                    <div className={s.textDelails}>
                        ...
                        <p className={s.additionalText}>
                            1. Образовательные и научные учреждения: для формирования цифровых библиотек, облегчения доступа к обширной базе знаний и методических материалов. <br/> <br/>
                            2. Библиотеки и архивы: для бережного хранения и расширения доступа к уникальным и ценным коллекциям. <br/> <br/>
                            3. Юридические сферы: для упрощения ведения и оперативного поиска в массивах законодательных и нормативных материалов. <br/> <br/>
                            4. Аудит и консультации: для простоты доступа к регламентам, стандартам и наставлениям в области финансовой и корпоративной отчетности. <br/> <br/>
                            5. Компании с разветвленной внутрикорпоративной документацией: для эффективностти работы с политиками компании, инструкциями и процессами. <br/> <br/>
                            6.Владельцами коллекций: для сохранения редких и ценных изданий. <br/> <br/>
                            7. Исследователями: для оперативного доступа к материалам для исследований. <br/> <br/>
                            8. Образовательными сотрудниками: для создания учебных баз и выполнения научных исследований. <br/> <br/>

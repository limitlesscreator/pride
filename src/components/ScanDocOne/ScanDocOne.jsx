                ...
                <div className={s.container}>
                    ...
                    <div className={s.textDelails}>
                        ...
                        <p className={s.additionalText}>
                            ...
                            1. Бухгалтерия и финансовый отдел - для оперативного доступа к первичным бухгалтерским документам, отчётности, банковским выпискам и подготовки к аудитам. <br/><br/>
                            2. Юридический отдел - для хранения и быстрого поиска всевозможных правовых документов, договоров, соглашений, юридических заключений. <br/><br/>
                            3. Отдел кадров - для управления персональными данными сотрудников, трудовыми договорами, личными делами, отпусками и больничными листами. <br/><br/>
                            4. Руководство компании - для анализа стратегических документов, отчётов, бизнес-планов, протоколов заседаний руководства и акционеров. <br/><br/>
                            5. Отдел продаж и закупок - для быстрого доступа к коммерческим предложениям, заказам клиентов, договорам поставки и сопроводительным товарным накладным. <br/><br/>
